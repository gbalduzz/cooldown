...
dca_plus = True  # True|False
U = 4            # on-site Coulomb interaction
d = 0.9          # density
...
temps = [1, 0.5, 0.25, 0.175, 0.15, 0.125, 0.1, 0.08, 0.06, 0.05, 0.045, 0.04, 0.035, 0.03, 0.025, 0.02, 0.015]
